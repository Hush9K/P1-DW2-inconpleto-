...
class produtoController {
    ...
    public function __construct($db) {
        $this->produto = new ($db); // Instancia a model produto com a conexão do banco de dados
    ...
    public function createProduto($nome_produto, $descricao, $preco, $estoque, $user_insert) {
        ...
        if ($result) {
            ...
            $this->logController->createLog('criação', $this->produto->getLastInsertId(), $user_insert);
